    ...
    var paste = (function(domGlobals) {
        ...
        var setup = function(editor, clipboard, draggingInternallyState) {
            ...
            editor.on('drop', function(e) {
                ...
                if (e.dataTransfer.types[0] === "fieldtype") {
                    var param = JSON.stringify({
                        "type": "DispatchFieldInit",
                        "fieldtype": dropContent["fieldtype"],
                    });
                    var myEvent = new CustomEvent('dragFieldEvent', {
                        "detail": {
                            "type": "DispatchFieldInit",
                            "fieldtype": dropContent["fieldtype"],
                        }
                    ...
                    //     title: "字段设置", //    对话框的标题
                    //     file: "static/test.html", //    放置对话框内容的HTML文件
                    //     width: 700, //    对话框宽度
                    //     height: 600, //    对话框高度
